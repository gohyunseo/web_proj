...
<nav class="navbar">
    ...
    <!-- 검색창 -->
      <div class="search-bar">
          ...
          <input name="searchKeyword" class="search-bar__input" type="text" placeholder="브랜드명, 제품명을 검색하세요!" />
...
<% } %>
	 ...
	 <%if(session.getAttribute("userGr")==null || session.getAttribute("userGr").equals("")){   %>
        ...
        <li class="dropdown"><a href="#"><img class="pictogram" src="resources/img/mypage.png"></a>
          ...
          <%if(session.getAttribute("userGr").equals(0)){  %>  			
      				...
      				<ul class= "pmmLogin"><a href="getBAskList.zo">리뷰관리</a></ul>
       ...
       <%} else if(session.getAttribute("userGr").equals(1)){  %>  		
      				...
      				<ul class= "brandLogin"><a href="getBAskList.zo">리뷰관리</a></ul>
     ...
     <li class="user" id="user">
      ...
      <%} else {   %>							<!-- 유저아이디 로그인 -->		
      				...
      				<ul class= "brandLogin"><a href="insertBAsk2.zo">1대1문의</a></ul>
      				<ul class= "userLogin"><a href="getBasket.ba?um_no=${userNo}">장바구니</a></ul>
      				</li >
      ...
      <li class="nav_item"><a href="login.me" onclick="login()" ><img class="pictogram" src="resources/img/cart.png"></a>
      		 ...
      		 <%} else {   %>	
      		<li class="nav_item"><a href="getBasket.ba?um_no=${userNo}" ><img class="pictogram" src="resources/img/cart.png"></a></li> 
      		<%} %>
      	</ul>
      </div>
</nav>
